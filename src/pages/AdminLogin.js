...
import {useLoginUserMutation} from '../app/services/usersApi'
...
const AdminLogin = () => {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
    const d =  await loginUser({email:data.email, password: data.password});
      dispatch(login(d.data))
      localStorage.setItem('user', d.data);
    ...
    <div className="adminLogin">
      <div className="container">
        ...
        <div className="adminLogin__form">
          ...
          <Link to='/signup'>
          <p  className="signinbtntbtn">Want to signup in this plarform?  Signup! </p>
        </Link>
        </div>
      </div>
